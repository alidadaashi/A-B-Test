var FP_LP_DONATIONS_TRUST = {
    ...
    addMoneyBackBanner: function() {
        ...
        html += '<div class="fp_banner_icon"><img src="https://variations-cdn.figpii.com/variations/gravitychallenges/rearrange/moneyBack.svg"></div>'
        html += '<h3 class="fp_banner_title"> <span> 100% </span> <strong> MONEY BACK </strong> GUARANTEE </h3>'
        html += '</div>'
        if (this.checkPageType) {
            html += '<p class="fp_banner_description"> You put down a $100 refundable security deposit. Don’t cheat, don’t quit, and lose 5% body fat in 6 weeks you get the whole thing back. It’s a free challenge, but you have to earn it. </p>'
        } else {
            html += '<p class="fp_banner_description"> You put down a $100 refundable security deposit. Don\'t cheat, don\'t quit, and lose 20lbs in 6 weeks you get the whole thing back. It\'s a free challenge, but you have to earn it. </p>'
        }
    ...
    addQuotesSlideshow: function() {
        ...
        html += '</div>        </div>            <div class="swiper-pagination"></div>'
        html += '</div>'
    ...
    addWeeks: function() {
        ...
        html += '<div class="title"> <h3> WEEK 1 </h3> <span> Fat Loss Kickstarter </span> </div>'
        html += '</div>'

        html += '<ul>'
        html += '<li> Official Weigh In </li>'
        html += '<li> In Home Workout Plan </li>'
        html += '<li> Full Video Exercise Library </li>'
        html += '<li> Custom Nutrition / Meal Plan </li>'
        html += '<li> Breaking Limiting Beliefs </li>'
        html += '<li> Detailed Gym Training Program </li>'
        html += '</ul>'
        html += '</div>'
    ...
    timer: function() {
        ...
        $('.ne div:contains("Registration Closing")').addClass('fp_registeration-text')
        ...
        var html = '<div class="fp_price">'
        html += '<span> Was $500 </span> <p> Now $100 </p>'
        html += '</div>'
        $('.fp_registeration-text').before(html)
        ...
        $('.fp_timer').after(sticky)

        $('.fp_timer_cta').after('<div class="fp_join"> Join Our Money-Back Guarantee Challenge </div>')

    },
    sixWeekBody: function() {
        $('.fp_timer').closest('.row').css('background-color', '#FAFAFA')
        var images = [
            'https://variations-cdn.figpii.com/variations/gravitychallenges/rearrange/sixWeek-1.png',
        ...
        html += '</div>                    <div class="swiper-pagination2"></div></div>'




        html += '</div>'
        $('.fp_timer_cta').next('.fp_join').after(html)
    ...
    purpleBanner: function() {
        ...
        html += '<div class="column"> <span> 93% </span> <p> Of People Hit <br> Their Goals </p> </div>'
