var FP_LP_DONATIONS_TRUST = {
    ...
    addDonationCTA: function() {
        $('.fp__header').after('<div class="fp__donation-box-default"><div class="fp__donation-box-default-first"><div class="fp__formBox"><span class="fp__label">$</span><input type="text" id="donation-amount-input" maxlength="5" name="donation" class="fp__donation-amount-input" value=""></div><div class="fp__donation-CTA" id="donation-cta">Donate to help me succeed</div></div><div class="fp__default-second"></div><div><div class="fp__donation-box-amount-button-row"><div class="fp__donation-box-amount-button" data-amount="25"><span class="fp__donation-box-amount-button-dollar">$</span>25</div><div class="fp__donation-box-amount-button" data-amount="50"><span class="fp__donation-box-amount-button-dollar">$</span>50</div><div class="fp__donation-box-amount-button fp__hero" data-amount="75"><span class="fp__donation-box-amount-button-dollar">$</span>75</div><div class="fp__donation-box-amount-button" data-amount="100"><span class="fp__donation-box-amount-button-dollar">$</span>100</div></div></div></div>')
    },
    linearProgress: function() {
        ...
        html += '<div class="fp__remained" style="left: calc(' + temp + '% - 20px)"> $' + (this.getDonationGoal() - this.getTotalDonationsAmount()) + '<span> STILL NEEDED </span> </div>'
        ...
        html += '</div>'
        html += '</div>';
        $('.fp__donation-box-default').after(html)
    },
    ...
    addSupporters: function() {
        var maxHeight = $('.fp__overlay__content').height() - 7;
        ...
        html += '<span class="fp__close">Close</span><h2 style="font-size: 20px; color: rgb(101, 101, 101);">' + $('h2:contains("Encouragers")').html() + '</h2>'
