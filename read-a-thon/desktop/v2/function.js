var FP_LP_DONATIONS_TRUST = {
    ...
    heroImage: function() {
        $('body > div:nth-child(3) > div:nth-child(2) > div:nth-child(1)').after('<div class="fp__playground"> <div class="fp__hero__image"> </div> </div>')
        var heroUrl = $('.wrapper .main >  div:nth-child(1)').css('background-image')

        $('.fp__hero__image').css('background-image', heroUrl)
    },
    // Add white overlay on image
    addOverlaay: function() {
        var html = ''
        html += '<div class="fp__overlay"><div class="fp__overlay__content"> </div></div>'
        $('.fp__playground').append(html)
    },
    ...
    friendsProgress: function() {
        ...
        html += '<a href="#fp__supporters" class="fp-donation-box-circle--mini"><canvas id="canvas" width="120" height="120"></canvas><span>' + totalSupporters + '</span><p> Supporters </p></a>'
    ...
    editHeadLine: function() {
        ...
        html += '<h2>' + fullName + ' has raised $' + this.getTotalDonationsAmount() + ' so far and has a $' + this.getDonationGoal() + ' goal.<br>Will you help us reach it? '
        html += '</div>'
    ...
    linearProgress: function() {
        ...
        html += '<div class="fp__raised"> $' + this.getTotalDonationsAmount() + '<span> Raised so far</span></div>'
        html += '<div class="fp__remained"> $' + this.getDonationGoal() + '</div>'
        ...
        html += '</div>'
        html += '</div>';
        $('.fp__donation.fp__side').before(html)
    },
    ...
    addSupporters: function() {
        var maxHeight = $('.fp__overlay__content').height() - 7 + 144;
