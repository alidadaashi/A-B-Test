var FP_AD_LP_DONATIONS_TRUST = {
    ...
    setHeroImageHeight: function() {
        $(window).load(function() {
            ...
            $('.fp__hero__image img').css('width', '')
        });
        $('#fp__supporters').css('margin-top', '5px')
    ...
    friendsProgress: function() {
        ...
        // just to know friend or friends
        var friend = ''
        ...
        html += '<div class="fp__supporters__title"> ' + friend + ' supported ' + fullName[0] + '</div>'
