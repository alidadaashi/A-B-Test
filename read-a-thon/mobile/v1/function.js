var FP_LP_DONATIONS_TRUST = {
    ...
    friendsProgress:function(){
    	...
    	html += '<div class="fp__supporters__container">'
    		html += '<div class="fp-donation-box-circle--mini"><canvas id="canvas" width="100" height="100"></canvas><span>'+totalSupporters +'</span></div>'
	    	html += '<div class="fp__supporters__description">'
		    	html += '<div class="fp__supporters__title"> friends supported Liana </div>'
...
draw();
    ...
    linearProgress: function(){
    	...
    	var html = '<div class="fp__linearProgress">'
    			html += '<div class="fp__remained" style="left: calc('+percentage+'% - 20px)"> $'+ (window.donationGoal - window.totalRaised) +'<span> STILL NEEDED </span> </div>'
