var FP_LP_DONATIONS_TRUST = {
    ...
    howSectionContent: function() {
        ...
        html += '<h2 class="fp__how__subtitle"> Use The Sliders Below to Adjust Your Participation and Donors to See What You Could Raise </h2>'
        html += '<div class="calculator-container"> <div class="calculator-inputs"> <div class="calculator-input-block"> <span class="calculator-input-title">The Number of Students</span> <input class="calculator-input" type="range" min="1" step="1" max="2000" value="100" id="students"> <span class="calculator-input-value" style="left: 5%;">100</span> </div><div class="calculator-input-block"> <span class="calculator-input-title">Percent Participation</span> <input class="calculator-input" type="range" min="50" step="1" max="100" value="75" id="percent"> <span class="calculator-input-value" style="left: 50%;">75</span> </div><div class="calculator-input-block"> <span class="calculator-input-title">Donors Per Student</span> <input class="calculator-input" type="range" min="1" step="1" max="25" value="5" id="donors"> <span class="calculator-input-value" style="left: 20%;">5</span> </div><p class="calculator-paragraph">If <span class="blue dynamic_percent">75%</span> of your students just got <span class="blue dynamic_donors">5</span> sponsors each.<br>Calculations are based on the current average donation of only <span class="blue">$34.10</span> per donor.</p></div><div class="calculator-result"> <div class="calculator-result-title"> <h3 id="annualCost">$100</h3> <span>YOU <br>WILL <br>RAISE</span> </div><div class="calculator-result-button"> <a href="/info/signup" class="purple-btn">Signup for FREE!</a> </div><div class="calculator-result-bullets"> <ul> <li>No Upfront Cost</li><li>No Risk</li><li>No Obligation</li></ul> </div></div></div>'
        $('.fp__how').html(html)
    },
