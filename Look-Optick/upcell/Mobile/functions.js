var FP_LP_DONATIONS_TRUST = {
    ...
    addModal: function() {
        ...
        var subHeader = '<h4 class="fp_modal_subtitle"> Look stylish for every occasion.<br>Buy your extra pair and save. </h4>'
    ...
    setMagnification: function() {
        ...
        $(document).on('click', '.fp_magnification div', function() {
            $('.fp_magnification').hide();
            $('.swatch.clearfix[data-option-index=1]  .fullwidth').css('display', 'flex')
        });
    ...
    changeColor: function() {
        ...
        $(document).on('click', '.swatch-element[dataTarget*=location] > label', function() {
            ...
            jQuery.ajax({
                ...
                // $(that).closest('.fp_slide').children('.swatch.clearfix[data-option-index="1"]').children('.fullwidth').children('.swatch-element.active').click();
                // Change button id
